...
class TestDateCSV(AccountTestInvoicingCommon):
    ...
    def test_datev_csv(self):
        ...
        self.assertIn(['238,00', 's', 'EUR', '34000000', '19', '01-12', 'BILL/2020/0001', '', 'BILL/2020/0001'], data)
        self.assertIn(['119,00', 's', 'EUR', '49800000', '19', '01-12', 'BILL/2020/0001', '', 'BILL/2020/0001'], data)
