...
def _hint_msg(error_code, afipws):
    ...
    if afipws == 'wsfe':
        ...
        data.update({
            ...
            '10216': _('The new RG 4919/2021 define that MiPYME document requires to inform the FCE Transmission Option. Set this one in your System Parameters creating a parameter with name "l10n_ar_edi.fce_transmission". Possible values are: SCA or ADC. These options means:\n * SCA - TRANSFERENCIA AL SISTEMA DE CIRCULACION ABIERTA\n * ADC - AGENTE DE DEPOSITO COLECTIVO'),
        })
